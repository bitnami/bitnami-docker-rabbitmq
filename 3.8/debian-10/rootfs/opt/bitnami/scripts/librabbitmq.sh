...
rabbitmq_create_combined_ssl_file() {
    local -r combined_ssl_file="/opt/bitnami/rabbitmq/etc/rabbitmq_combined_keys.pem"
...
EOF
        local combined_ssl_file="/opt/bitnami/rabbitmq/etc/rabbitmq_combined_keys.pem"
